...
ESC = 'escape'.freeze
SMALL = 'q'.freeze
RIGHT_COMMAND = 'right_command'.freeze
...
ROMAN_MAP = {
  ...
  '左矢印' => [key(LEFT_ARROW)],
  '右矢印' => [key(RIGHT_ARROW)],
  '二左矢印' => [key(LEFT_ARROW), key(LEFT_ARROW)],
  '二右矢印' => [key(RIGHT_ARROW), key(RIGHT_ARROW)],
  'ホイール右' => [mouse_key_hwheel(32)],
  'ホイール左' => [mouse_key_hwheel(-32)],
  '確定アンドゥ' => [key_with_control(BACK_SPACE)],
    ...
    'rules' => [
      {
        ...
        'manipulators' => [
          ...
          editmode_one_left('t','コピー'),

          editmode_one_left('a','頁下'),
          editmode_one_left('s','頁上'),
#          editmode_one_left('a','リドゥ'),#shift + command + z
#          editmode_one_left('s','保存'),
          editmode_one_left('d','ホイール左'),
          editmode_one_left('f','ホイール右'),
          editmode_one_left('g','カット'),

          editmode_one_left('z','アンドゥ'),
          editmode_one_left('x','確定復行'),#確定Undo
          editmode_one_left('c','二左矢印'),
          editmode_one_left('v','二右矢印'),
          editmode_one_left('b','ペースト'),
          ...
          editmode_two_left('e','・改'), #なんか変わるみたいだがわからんのでそのまま
          ...
          three_keys(SPACEBAR,'v','h','ゃ'),
          three_keys(SPACEBAR,'v','p','ゅ'),
